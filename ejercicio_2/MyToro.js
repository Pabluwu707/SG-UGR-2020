class MyToro extends THREE.Object3D {
  ...
  createGUI (gui,titleGui) {
    ...
    folder.add (this.guiControls, 'radiusP', 0.1, 5.0, 0.1).name ('Radio Principal : ').listen();
    folder.add (this.guiControls, 'radiusT', 0.1, 5.0, 0.1).name ('Radio Tubo : ').listen();
    folder.add (this.guiControls, 'resolutionTo', 3.0, 20.0, 1.0).name ('Resolucion Toro : ').listen();
    folder.add (this.guiControls, 'resolutionTu', 3.0, 20.0, 1.0).name ('Resolucion Tubo : ').listen();

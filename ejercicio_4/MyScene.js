...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.trebol.position.x = -1.2;
    this.add (this.pica);
    this.pica.position.x = 1.2;
    this.add (this.diamante);
    this.diamante.position.x = 1.2;
    this.diamante.position.y = 2.8;
    this.add (this.corazon);
    this.corazon.position.x = -1.2;
    this.corazon.position.y = 2.8;
